...
load_env
require_env LITELLM_CONTAINER PROXY_CONTAINER INGRESS_CONTAINER INTERNAL_NETWORK EGRESS_NETWORK INGRESS_NETWORK MASTER_KEY_SECRET AUTH_VOLUME
...
"$PODMAN" network rm "$INGRESS_NETWORK" >/dev/null 2>&1 || true
